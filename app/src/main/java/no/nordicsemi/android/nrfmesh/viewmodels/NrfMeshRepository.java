...
//    void setVendorModel(final VendorModel model){
//        mSelectedModel.postValue(model);
//    }
    ...
    @Override
    public void onMessageReceived(@NonNull MeshMessage meshMessage) {

    }

    @Override
    public void onMessageSent(@NonNull MeshMessage meshMessage) {
