# DuraPro-Android-nRF-Mesh-Debug
基於北歐半導體(Nordic Semiconductor ASA)開發的Android-nRF-Mesh-Library，本軟體修改原版部分功能，以支援對裝置動作紀錄Log紀錄，以及新增繁體中文版本，系統設定繁體中文則APP會變更為繁體中文版
...
# 以下資訊為北歐半導體(Nordic Semiconductor ASA)原版說明
## About
...
```groovy
implementation 'no.nordicsemi.android:mesh:3.3.2'
```
