...
interface MeshMngrApi {
     ...
     * <p>
     * This method will send a provisioning invite to the connected peripheral. This will help users to
     * identify a particular node before starting the provisioning process.
